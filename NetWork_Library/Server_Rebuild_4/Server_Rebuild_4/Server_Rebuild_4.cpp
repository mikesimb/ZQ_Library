...
// CServer_Rebuild_4App 构造

CServer_Rebuild_4App::CServer_Rebuild_4App()
{
	// 支持重新启动管理器
...
// 唯一的一个 CServer_Rebuild_4App 对象

CServer_Rebuild_4App theApp;


// CServer_Rebuild_4App 初始化
